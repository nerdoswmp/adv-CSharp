...
namespace testesAutomatizados
{
    ...
    public class TestDAO
    {
        ...
        public void insertAddress()
        {
            ...
            if (addressModel.validateObject(addressModel))
            {
